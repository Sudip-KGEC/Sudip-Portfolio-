...
const ContactButton = ({ href = "#contact", label = "Contact me" , onClick}) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center gap-2 px-5 md:px-6 py-2.5 rounded-xl bg-zinc-900 border border-zinc-800 text-sm font-medium text-zinc-200 tracking-wide transition-all duration-300 group-hover:border-orange-500/50 group-hover:text-white group-hover:-translate-y-px">
        <span>{label}</span>
        <svg
