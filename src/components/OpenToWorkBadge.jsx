...
const OpenToWorkBadge = () => (
  <div className="inline-flex w-fit items-center gap-2 rounded-full border border-green-500/20 bg-zinc-900/80 px-3 py-1 backdrop-blur-md shadow-[0_0_20px_rgba(34,197,94,0.12)]">
